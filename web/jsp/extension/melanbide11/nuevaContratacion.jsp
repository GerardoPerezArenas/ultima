...
this                    this.base.style.height = this.view.style.height = (alto + 2 * CB_Borde + CB_Scroll) + "px";
 ...
 var comboListaTitulacionRequerida;
            ...
            function guardarDatos() {
                if (validarDatosNumericosVacios() && validarDatos()) {
                    ...
                    var funciones = v('funciones'); funciones = funciones ? safeReplaceQuotes(funciones) : ""; // m�x 200 (validado fuera)
                    ...
                    if (nuevo != null && nuevo == "1") {
                            ...
                            // Hist�ricos: si no est�n en el DOM, enviamos vac�o sin romper
                        ...
                        parametros = "tarea=preparar&modulo=MELANBIDE11&operacion=modificarContratacion&tipo=0"
                            ...
                            + "&oferta=" + v('oferta')
                                ...
                                + "&ocupacion=" + v('codListaOcupacion')
                                + "&desOcupacionLibre=" + encodeURIComponent(v('desOcupacionLibre'))
                                // Hist�ricos (solo consulta): enviamos vac�o si no existen
                                + "&desTitulacionLibre=" + v('desTitulacionLibre')
                                + "&titulacion=" + v('codListaTitulacion')
                                + "&cProfesionalidad=" + v('codListaCProfesionalidad')
                                + "&modalidadContrato=" + v('modalidadContrato')
                    ...
                    try {
                        ...
                        if (ajax.readyState == 4 && ajax.status == 200) {
                            ...
                            if (!xmlDoc || !xmlDoc.documentElement) {
                                alert('Error: la respuesta del servidor no es v�lida. Intente de nuevo o contacte soporte.');
                                return;
                            }
                            nodos = xmlDoc.getElementsByTagName("RESPUESTA");
                            if (!nodos || !nodos[0]) {
                                alert('Error: no se recibi� respuesta v�lida del servidor.');
                                return;
                            }
...
<div style="width: 250px; float: left;" class="etiqueta">
                    ...
                    <!-- TODO hist�rico: TITULACION y DESTITULACION
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide11I18n.getMensaje(idiomaUsuario,"label.desTitulacionLibre")%>
                        </div>
...
<!-- Desplegable TITREQPUESTO (patr�n legacy: c�digo + descripci�n + ancla) -->
<div class="lineaFormulario">
  <div class="etiqueta" style="width: 250px; float: left;">
